...
class TodoCardFilter extends StatelessWidget {
  ...
  //metodo pata atualizar tituto do task filter conforme numero de tasks finalizadas.

   int _getTasksToFinish(){
   ...
   Widget build(BuildContext context) {
       return InkWell(
        onTap: () => context.read<HomeController>().findsTasks(filter: taskFilter),
         child: Container(
          ...
          decoration: BoxDecoration(          
            ...
            child: Column(
              ...
              children: [
                Text(
                  '${_getTasksToFinish().toInt()} TASKS', 
                   style: context.titleStyle
                    .copyWith(fontSize: 10, color: selected? Colors.white : Colors.black ),),
