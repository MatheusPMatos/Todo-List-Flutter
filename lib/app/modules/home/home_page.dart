...
class _HomePageState extends State<HomePage> {
  ...
  void initState() { 
    super.initState();
    DefaultListenerNotifier(changeNotifier: widget._homeController)
      .listener(
        context: context, 
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ...
      widget._homeController.findsTasks(filter: TaskFilterEnum.today);
    });
  ...
  Future<void> _goToCreatePage(BuildContext context) async {
       ...
       return Scaffold(
           appBar: AppBar(
            ...
            actions: [
              PopupMenuButton(
                onSelected: (value){
                  widget._homeController.hideFinishedTasks();
                },
